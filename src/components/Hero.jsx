  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center text-center px-4 py-16 bg-navy">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url(${process.env.PUBLIC_URL}/assets/img/hero_mansion.png)`,
          filter: 'blur(2px)'
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <button 
          ...
          className="bg-gold text-navy px-10 py-5 rounded-full font-bold text-sm tracking-wide uppercase hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 opacity-0 animate-scale-in delay-500"
        >
