...
const Footer = () => {
  return (
    <footer className="py-12 md:py-16 px-4 text-center bg-[#0d0d0d] border-t border-white/10">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="flex justify-center gap-6 mb-8">
          <a
            href="https://www.instagram.com/erikasousaoficiall_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
            target="_blank"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#25D366] hover:text-[#20BA5A] transition-colors duration-300"
            aria-label="WhatsApp"
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="pt-6 border-t border-white/10">
          <p className="font-outfit text-white/40 text-xs">
