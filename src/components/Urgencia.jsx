      ...
      <section className="py-24 md:py-40 px-4 relative bg-cover bg-center" style={{
        ...
        <div className="container mx-auto max-w-5xl relative z-10">      
          ...
          <div className="text-center space-y-6 text-lg text-white/90 leading-relaxed">
            <p className="font-outfit animate-fade-in-up delay-300">E como todo grande evento…</p>
            <p className="font-playfair text-2xl text-gold font-semibold italic animate-zoom-in delay-400">
              Nem todas terão acesso.
            </p>
            <p className="font-outfit font-medium text-white animate-slide-in-up delay-500">
