    ...
    <section className="py-20 md:py-32 px-6 bg-[#0d0d0d]">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* Card Setor Diamante */}
          <div className="bg-[#181818] rounded-2xl p-8 md:p-10 text-left border border-gold/30 relative overflow-hidden transform md:-translate-y-4 shadow-[0_0_40px_rgba(201,168,76,0.15)]">
